...
namespace electronics
{
    public  static class Extention
    {
        ...
        public static int Discount(this int price,int? discount)
        {
        ...
        //public static IEnumerable<string> GetSize(this string sizeColection)
        //{
        //    IEnumerable<string> sizes = sizeColection.Split(',');
